...
export default function ComplianceAlerts() {
  ...
  console.log("filteredPoliciesList", filteredPoliciesList);
  ...
  return (
    <div className="flex w-full h-full">
      <div className="flex-[4] flex flex-col ">
        {/* Header */}
        <DashboardAppbar
          leading={ComplianceAlertIcon}
          title={"Compliance Alerts"}
          subtitle={"Stay updated with compliance changes 🗓️"}
        />
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center pt-8">
              ...
              <p className="text-sm text-[#99A0AE] text-center">
                No compliance alerts found at this time. <br />
